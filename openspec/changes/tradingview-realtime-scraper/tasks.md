...
- [x] 4.1 TradingView-primary/Yahoo-fallback coordinator
- [x] 4.2 Deterministic snapshot scorer and top-10 shortlist
- [x] 4.3 Structured snapshot prompt builder for LLM reasoning
- [x] 4.4 Test fallback provenance, top-10 bound, and prompt fields (RED→GREEN)

## 5. Railway Rollout

- [x] 5.1 Add scraper environment variables and README documentation
- [x] 5.2 Deploy Playwright image with no public browser endpoint
- [x] 5.3 Validate production shadow mode and enable TradingView primary
